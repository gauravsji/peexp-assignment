...
<table id="view_order_html" class="sieve table table-bordered table-striped table-fixed" style="border-collapse:collapse;">
	...
	<tbody>
		...
		{
			$sql = "SELECT * FROM ss_order o,vendor v,customer c,project p where o.vendor_id=v.vendor_id and o.customer_id=c.customer_id and o.project_id=p.project_id and o.delete_status='0' and order_status='Order Placed' and o.location='".$user_result['location']."'";
		}
		else
		{
			$sql = "SELECT * FROM ss_order o,vendor v,customer c,project p where o.vendor_id=v.vendor_id and o.customer_id=c.customer_id and o.project_id=p.project_id and o.delete_status='0' and order_status='Order Placed'";
		}
