		...
		<!-- Left Side Panel Which Contains Navigation Menu -->
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1>Cancelled Task Report  <div class="btn-toolbar pull-right">
					...
					<a href="../reports/task_report_html.php" class="btn btn-xs btn-success">All Tasks</a>
					</div></h1>
				</section>
						...
						<div class="box-body">
							...
							<table id="view_task_html" class="table table-bordered dt-responsive table-condensed table-striped">
								...
								<tbody>
									...
									echo '<td align="center" style="width:10%" contenteditable="true" onBlur=\'saveToDatabase(this,"task_start_date",'. $row['task_id'].')\' onClick="showEdit(this)">'. $row['task_start_date'] .'</td>';
									
									echo '<td align="center" style="width:10%"  contenteditable="true" onBlur=\'saveToDatabase(this,"task_due_date",'. $row['task_id'].')\' onClick="showEdit(this)">'. $row['task_due_date'].'</td>';
									...
									if( $row['task_status']=='Ongoing')
										{
										echo '<td style="width:12%" > <div align="center" class="badge bg-blue">'.$row['task_status'].'</div></td>';
										}
										else if( $row['task_status']=="Completed")
										{
										echo '<td style="width:12%" > <div align="center" class="badge bg-green" onBlur=\'saveToDatabase(this,"task_status",'. $row['task_id'].')\' onClick="showEdit(this)">'.$row['task_status'].'</div></td>';
										}
										else if( $row['task_status']=="Cancelled")
										{
										echo '<td style="width:12%" > <div align="center" class="badge bg-red" onBlur=\'saveToDatabase(this,"task_status",'. $row['task_id'].')\' onClick="showEdit(this)">'.$row['task_status'].'</div></td>';
										}									
