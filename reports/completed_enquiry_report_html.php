								...
								<tbody>
									<?php
										...
										$sql = "SELECT * FROM enquiry e
												...
												WHERE e.delete_status <> 1 and e.enquiry_status='CLOSED - CONVERTED TO ORDER' and e.location='".$user_result['location']."'";
										}
										else
										{
											$sql = "SELECT * FROM enquiry e
												...
												LEFT OUTER JOIN project p ON e.project_id = p.project_id
												LEFT OUTER JOIN users u ON u.id = e.enquiry_assignee
												WHERE e.delete_status <> 1 and e.enquiry_status='CLOSED - CONVERTED TO ORDER'";
										}
