...
<table id="view_order_html" class="sieve table table-bordered table-striped table-fixed" style="border-collapse:collapse;">
		...
		{
			$sql = "SELECT * FROM ss_order o,vendor v,customer c,project p where o.vendor_id=v.vendor_id and c.subset=".$_SESSION['groupId']." and o.customer_id = c.customer_id and o.project_id=p.project_id and o.delete_status=0 and o.order_status='Order Fulfilled' order by o.order_id DESC";
		}
		else
		{
			$sql = "SELECT * FROM ss_order o,vendor v,customer c,project p where o.vendor_id=v.vendor_id and o.customer_id=".$_SESSION['id']." and o.project_id=p.project_id and o.order_status='Order Fulfilled' and o.delete_status=0 order by o.order_id DESC";
		}
