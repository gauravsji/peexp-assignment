<?php
  ...
  $enquiry_status = mysqli_real_escape_string($conn ,'Awaiting Quote');
    ...
    enquiry_details,enquiry_assignee,enquiry_status,enquiry_priority,delete_status,data_entered_by,end_date,created_at,updated_at,pi_status) VALUES (
	...
	if ($error==1)
	{
		...
		header("Location:".$GLOBALS['view_rfq_html']."?id=".$last_inserted_id);
	}
	else
	{
		//On Error
