		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				<section class="content-header">
					<h1>
						Request Details
						<a href=<?php echo $url."/reports/rfq_report_html.php";?> class="btn pull-right">
					...
					<div class="box">
						<div class="box-body pad">
										...
										<?php
											...
											if($enquiry_result['po_status'] != "approved")
											{
												...
												<div class="btn-toolbar">
														<?php
														  echo '<a class="btn btn-primary btn-flat btn-sm pull-right" href ='.$GLOBALS['edit_rfq_html']."?id=".$enquiry_id.'>'?>
														 Edit
														</a>
													</div>
												<?php
											...
											<table class="table">
												<tr><td> Status: </td><td> <strong>
													<?php
															...
															elseif ($enquiry_result['enquiry_status'] == "Quote Sent") {
																echo "Quote Received";
															}
															elseif ($enquiry_result['enquiry_status'] == "Rework Requested") {
																echo "Rework Requested";
															}
															elseif ($enquiry_result['enquiry_status'] == "Order Received") {
																echo "Quote Accepted";
															}
															else {
							...
							<div class="form-group col-md-12" style="margin-top: 20px;">
								<div class="page-header">
									<center><strong>PO Details</strong></center>
								</div>
								<div class="table-responsive">
