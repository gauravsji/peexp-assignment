	...
	<script>
		function delete_record(e,draft_id)
		{
			...
			if (r == true)
			{
				...
				$.ajax({
					type : 'post',
					url : '../php/delete/delete_pi_customer_enquiry.php', //Here you will fetch records
   ...
   //document.getElementById('ui_project_name').disabled = true;
		  ...
		  $('#edit_enquiry_product_modal').on('show.bs.modal', function (e)
				{
					...
					$.ajax({
						type : 'post',
						url : '../php/get/get_pi_enquiry_item.php', //Here you will fetch records
	...
	<body class="hold-transition skin-blue fixed sidebar-mini">
				...
				<section class="content-header">
					<h1>Edit Enquiry
						<div class="btn-toolbar pull-right">
							<a href="../html/view_pi_html.php?id=<?php echo $ss_enquiry_id;?>" class="btn btn-sm btn-info">View RFQ</a>
							<a href="../html/add_pi_html.php" class="btn btn-sm btn-primary">New RFQ</a>
							<a href="../reports/rfq_report_html.php" class="btn btn-sm btn-success">RFQ Report</a>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="box box-primary">
								...
								<form action="../php/update/update_pi_enquiry.php" method="POST">
								...
								<div class="form-group col-md-2">
									...
									<div class="input-group">
										...
										<select name="ui_assignee_name" id="ui_assignee_name" class='form-control select2' style='width: 100%;'>
											...
											<?php
												$query = $conn->query("SELECT * FROM customer WHERE subset= ".$_SESSION['groupId']." ");
												...
												if($rowCount > 0)
											{
												...
												{
													if ($row['customer_id'] == $enquiry_result['data_entered_by'])
														echo '<option value="'.$row['customer_id'].'" selected>'.$row['customer_name'].'</option>';
													else
														echo '<option value="'.$row['customer_id'].'" >'.$row['customer_name'].'</option>';
														}
								...
								<div class="form-group col-md-3">
									...
									<div class="input-group">
										...
										<input name="ui_enquiry_status" id="ui_enquiry_status" class='form-control' style='width: 100%;' value=<?php echo $enquiry_result['enquiry_status'];?> disabled>
								...
								<!--Enquiry Priority-->
										...
										<div class="form-group col-md-3">
											...
											<div class="input-group date">
												...
												<input type="date" class="form-control" name="ui_rfq_edd"  id="ui_rfq_edd" value=<?php echo $enquiry_result['end_date']?>/>
											</div>
										</div>
		...
		$('#update_rfq_data').on('click',function(){
			...
			$.ajax(
			{
				url: "../php/update/update_pi_enquiry.php",
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="modal_product_quantity"  name="modal_product_quantity" maxlength="50" onkeypress='return event.charCode>= 48 && event.charCode <= 57 || event.charCode ==46' required/>
									</div>
								</div>
								<!--Quantity-->
...
function fetchMysqlDatabase(draft_id)
{
	...
	$("#save_edit_line_item_submit").click(function()
	{
			...
			$.ajax(
			{
				url: "../php/update/update_pi_enquiry_item.php",
				type: "POST", // you can use GET
