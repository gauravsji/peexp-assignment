   ...
   //document.getElementById('ui_project_name').disabled = true;
	...
	<body class="hold-transition skin-blue fixed sidebar-mini">
				...
				<section class="content-header">
					<h1>Edit Request
						<div class="btn-toolbar pull-right">
							<a href="../html/view_rfq_html.php?id=<?php echo $ss_enquiry_id;?>" class="btn btn-sm btn-info">View Request</a>
							<a href="../html/add_rfq_html.php" class="btn btn-sm btn-primary">New Request</a>
							<a href="../reports/rfq_report_html.php" class="btn btn-sm btn-success">Request Report</a>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="box box-primary">
								...
								<form action="../php/update/update_rfq_enquiry.php" method="POST" onsubmit="submit.disabled = false; return true;">
								...
								<div class="form-group col-md-3">
									...
									<div class="input-group">
										...
										<?php
											if($enquiry_result['enquiry_status'] == "RFQ Created")
												echo "<input name='ui_enquiry_status' id='ui_enquiry_status' class='form-control' style='width: 100%;' value='RFQ Craeted' disabled>"
										?>
		...
		$('#update_rfq_data').on('click',function(){
			...
			files = $('#file').val();
			console.log("Data Entering into the Loop");
			$.ajax(
			{
