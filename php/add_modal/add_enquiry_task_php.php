...
$sql = "INSERT INTO $tbl_name(task_name,task_description,task_assignee,task_start_date,task_due_date,task_priority,task_status,task_remarks,task_module_name,task_module_id,data_entered_by,location,created_date,last_update_date,delete_status) VALUES ('$task_name','$task_description','$assignee_name',NOW(),'$due_date','High','$task_status','$task_remarks','ENQUIRY','$enquiry_id','$user_id','$location',CURDATE(),CURDATE(),0)";
