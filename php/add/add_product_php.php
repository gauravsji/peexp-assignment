<?php
	...
	$brand_id= mysqli_real_escape_string($conn,$_POST['ui_brand_name']);
	...
	if(isset($_POST)==true && empty($_POST)==false): 
		//Store Posted Data To PHP Variable
		$product_set_attribute_id=$_POST['product_set_attribute_id'];
	...
	{
		//On Successful
		fn_add_activity_log("Product",$last_inserted_id,"Product Created",$user_id,$conn);
