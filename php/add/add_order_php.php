<?php
	...
	//Insert Query
	$query1 = "INSERT INTO $tbl_ss_order(vendor_id,customer_id,project_id,order_date,order_placed_by,order_confirmation_type,order_assignee,order_status,order_remarks,order_brief_details,order_with_bill,data_entered_by,location,created_date, last_update_date, delete_status) VALUES ('$vendor_id','$customer_id','$project_id','$order_date','$order_placed_by','$confirmation_type','$order_assignee_name','$order_status','$order_remarks','$brief_order_details','$with_bill','$order_by','$location', CURDATE(), CURDATE(),0)";
