	...
	<!-- Left Side Panel Which Contains Navigation Menu -->
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1>
					Edit Project <a href="../reports/project_report_html.php" class="btn pull-right btn-sm btn-primary">Project Report</a>
					</h1>
				</section>
								...
								<div class="box-body pad">
									...
									<div class="form-group col-md-4">
										...
										<div class="input-group">
											...
											{
												if ($row['customer_id'] == $project_result['customer_id']):
												{
									...
									<div class="form-group col-md-4">
										...
										<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-user"></i></span>
											<input type="text" class="form-control" placeholder="Client Name" id="client_name" style="text-transform:capitalize" onkeypress='return event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 97 && event.charCode <= 122 || event.charCode==32' maxlength="30" name="client_name" value="<?php echo $project_result['project_client_name'] ?>"/>
										</div>
									</div>
									<!--Client Name-->
									...
									<div class="form-group col-md-4">
										...
										<div class="radio">
											<label>
											<input type="radio" name="type_of_project" id="type_of_project" value="Residential" <?php if($project_result['project_type_of_project']=='Residential') {echo "checked";}?>/>
											Residential
											</label>
										</div>
										<div class="radio">
											<label>
											<input type="radio" name="type_of_project" id="type_of_project" value="Commercial" <?php if($project_result['project_type_of_project']=='Commercial') {echo "checked";}?>/>
											Commercial
											</label>
										</div>
										<div class="radio">
											<label>
											<input type="radio" name="type_of_project" id="type_of_project" value="Other" <?php if($project_result['project_type_of_project']=='Other') {echo "checked";}?>/>
											Other
											</label>
										</div>
									</div>
